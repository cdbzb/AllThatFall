...
%bn2  
 ...
 R2 |  R2 |  R2 |  R2 |    % lh rh kbR kbL 
  ...
  R2 | R2 | %vn vn2  
  R2 | R2 | R2 |  % va vc cb 
  <<\instrumentSwitch "kl" \Q #"kl" {  s2} \new Staff \Q#"vox" {s2} >> | R2 |\instrumentSwitch "hn" \Q #"hn"{  s2} |  R2 |  R2 |  R2 |  % I  II  III  IV  V  VI    
...
%bn90  
  ...
  \instrumentSwitch "kl" \Q "kl" {s8. s }| \instrumentSwitch "tn" \Q "tn" {s8. s }| \instrumentSwitch "hn" \Q "hn" {s8. s }| \instrumentSwitch "va" \Q "va" {s8. s } |\instrumentSwitch "cb" \Q "cb" {s8. s }|\instrumentSwitch "vc" \Q "vc" {s8. s }|  % I  II  III  IV  V  VI    
...
%parts: 1: fl, 2: ob, 3: rest, 4: va, 5: rest, 6: vc
...
%parts: 1: fl, 2: ob, 3: hn, 4: va, 5: cb, 6: vc
...
r2. r2  | << {bes4 d f aes \times 2/3 {c8 e d~ }}  \\ {<bes,, bes'>1~ <bes bes'>4} >> |  r2. r2 |  r2. r2 |   % lh rh kbR kbL 
  ...
  \Q "va" {s2. s2 }| \Q "vII" { s2. s2 }|\Q "ob" {s2. s2 }| \clef bass \Q "vn" {s2. s2 } |\clef tenorG \Q "cb" {s2. s2 }|\Q "vc" {s2. s2 }|  % I  II  III  IV  V  VI    
...
r2. r2. r2 | r2. r2. r2 | g2 ais4~ ais2 b2. |a,2 r4 gis,2 r4 b,4 r |a,,2 r4 gis,,2 r4 b,,4 r |  % vn vII va vc cb 
  \Q #"kl" { r2. r2. r }|  \Q #"ob" { r2. r2. r }|  \Q #"hn" { r2. r2. r }|  \Q #"tn" { r2. r2. r }|  \Q #"cb" { r2. r2. r }| \Q "vc" { r2. r2. r } |  % I  II  III  IV  V  VI     
...
g2 r1 |e2 r1 | R1. |e,2 r4 <<{g,2^"Soli" r4}\\{fis,4 r2}>>  |r2. <g, d>2.\arpeggio |  % vn vII va vc cb 
  \Q #"kl" {s1. }| \instrumentSwitch "vn" \Q #"vn" {s1. }| \instrumentSwitch "hn" \Q #"hn" {s1. }| \instrumentSwitch "vn" \Q #"vII" {s1. }| \Q #"cb" { s1. }| \clef bass \Q "vc" { s1. } |  % I  II  III  IV  V  VI     
...
R2 | R2 | R2 | dis,8-> r e,-> r| R2 |  % vn vII va vc cb 
 \instrumentSwitch "tn" \Q #"tpt" {s2 }|  \Q #"vn" { s2 }|  \Q #"hn" { s2 }|  \Q #"vII" { s2 }| \instrumentSwitch "bn" \Q #"bn" {s2 }| \Q "vc" { s2 } |   % I  II  III  IV  V  VI     
...
R2 | R2 | \relative c' {r4 fis8 eis16 dis } |fis,4-> fis~ | R2 |  % vn vII va vc cb 
 \instrumentSwitch "kl" \Q #"kl" {s2 }| \instrumentSwitch "tn" \Q #"tpt" {s2 }|  \Q #"hn" { s2 }| \instrumentSwitch "va" \Q #"va" {s2 }|  \Q #"bn" { s2 }| \Q "vc" { s2 } |  % I  II  III  IV  V  VI     
...
%parts: 1: tn or tpt, 2: rest, 3: hn, 4: rest, 5: cb, 6: vc
...
R2. | R2. | R2. | % tym perc fol 
 ...
 r8 g'\f g' g' <g' a'>8. <g' a'>16   | r8 g'\f f' e' d' c' |<<{r8 g g g g g}\\g,,2.>> | g'8) \clef bass g\f <g f> <g e> <a g d>8 c16~ <c g a> |  g2.-.->^"pizz"  |  % vn vII va vc cb 
  \clef treble \Q #"vII" { s2. }|  \Q #"vn" { s2. }|  \clef treble \Q #"hn" { s2. }|\instrumentSwitch "vcsilent"<<{r8 g g g g g}\\g,,2.>> |  \Q #"cb" { s2. }| \Q "vc" { s2. } |  % I  II  III  IV  V  VI     
...
%parts: 1: vn, 2: vnII, 3: hn, 4: va, 5: cb, 6: vc
...
%parts: 1: kl, 2: rest, 3: rest, 4: rest, 5: bn, 6: rest
...
\Q #"tn" { s2. }| \Q #"vn" { s2. }|\Q #"vII" { s2. }| \Q #"va" { s2. }|  \Q #"bn" { s2. }| \Q #"vc" { s2. }|  % I II III IV V VI       
...
%parts: 1: fl, 2: ob, 3: hn, 4: vn, 5: cb, 6: vc
...
%parts: 1: va, 2: rest, 3: rest, 4: rest, 5: rest, 6: vc
...
R2 | R2 | % hpL hpR 
 ...
 \instrumentSwitch "kl" \Q #"kl" {s2 }| \instrumentSwitch "vn" \Q #"vn" {s2 }|  \Q #"hn" { s2 }| \instrumentSwitch "va" \Q #"va" {s2 }|  \Q #"bn" { s2 }| \Q #"vc" { s2 }|  % I II III IV V VI        
...
\instrumentSwitch "va" {\clef alto r4 \times 2/3 {f4^"solo" c' f}} |  \Q #"vII" { s2. }|  \Q #"hn" { s2. }|  \Q #"va" { s2. }|  \Q #"cb" { s2. }|b,4 a,2| % I II III IV V VI 
...
%bn466 IN DEMO THIS BAR IS LONGER...
...
%parts: 1: vnII, 2: rest, 3: rest, 4: va, 5: cb, 6: rest
...
%parts: 1: kl, 2: vnII, 3: rest, 4: va, 5: rest, 6: rest
...
%parts: 1: fl, 2: rest, 3: rest, 4: rest, 5: bn, 6: vc
...
%parts: 1: kl, 2: ob, 3: rest, 4: va, 5: rest, 6: rest
...
%parts: 1: kl, 2: vn, 3: vnII, 4: va, 5: rest, 6: vc
...
%parts: 1: vn, 2: vnII, 3: rest, 4: va, 5: rest, 6: vc
...
a4. a'4. | <g' c''>2. | d'4.~ \times3/4{d'4 c'8 b} |<<{\context Staff="vcossia" { c''4.\> s\!}}  d2.~ >> |  R2. |  % vn vII va vc cb 
  \Q #"kl" { s2. }|  \Q #"vn" { s2. }|  \Q #"vII" { s2. }| \Q #"va" { s2. }| \Q #"cb" { s2. }| \Q #"vc" { s2. }|  % I  II  III  IV  V  VI  
%parts: 1: vn, 2: vnII, 3: rest, 4: va, 5: rest, 6: rest
...
%parts: 1: kl, 2: tn or tpt, 3: rest, 4: va, 5: rest, 6: vc
...
%parts: 1: fl, 2: tn or tpt, 3: rest, 4: va, 5: rest, 6: vc
...
%parts: 1: vnII, 2: rest, 3: rest, 4: va, 5: rest, 6: rest
...
%parts: 1: fl, 2: rest, 3: rest, 4: va, 5: rest, 6: vc
...
R2. |  R2. |  R2. | f2. |  R2. |  % vn vII va vc cb 
  \Q #"fl" { s2. }|  \Q #"tn" { s2. }|  \Q #"vII" { s2. }| \Q #"va" { s2. }| \Q #"cb" { s2. }| \Q #"vc" { s2. }|  % I  II  III  IV  V  VI  
%parts: 1: rest, 2: rest, 3: rest, 4: rest, 5: rest, 6: vc
...
%parts: 1: rest, 2: rest, 3: rest, 4: rest, 5: rest, 6: rest
...
%parts: 1: vn, 2: vnII, 3: rest, 4: rest, 5: rest, 6: rest
