...
<e g b e>2.\arpeggio | e8 g b e b g |  R2. |  R2. |   % rh lh kbR kbL 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. |  R2. |  R2. | % hn tpt  tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
f=8 ges g aes | <cis=, cis'>8.  <c c'> <b b'>8 |  R2 |  R2 |   % rh lh kbR kbL 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 |  R2 |  R2 | % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
e4 r | <bes bes'> r |  R2 |  R2 |   % rh lh kbR kbL 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 |  R2 |  R2 | % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<<{f4.~ f4 g8} \\ f2.~>> | R2. |  R2. |  R2. |   % rh lh kbR kbL 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. |  R2. |  R2. | % hn tpt  tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
R2 | R2 | R2 | R2 | R2 | % vn vII va vc cb 
 ...
 %bn64
R2 | |
\clef bass << {s4.. <g= a cis>16 }\\ {d16 d cis b a g fis e}>> | d16) d cis b a g fis e |  R2 |  R2 |   % rh lh kbR kbL 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 |  R2 |  R2 | % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
R2 | R2 | R2 | R2 | R2 | % vn vII va vc cb 
 ...
 %bn1
\mark \default \mark \default \instrumentSwitch "Rooney" \time 5/8 e='8 c e bes'4 | \lyricmode {are you not well? } | 
...
r2. | r4. g=,8 d' g | R2. | R2. | % rh lh kbR kbL Should be D in LH???
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | R2. | % hn tpt tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
%bn44
  ...
  <c ees fis a>2:32->( | <aes, aes'>2 |  R2 |  R2 |   % rh lh kbR kbL   
  R2 |R2 |R2 |R2 | % fl ob kl bn 
  R2 |  R2 | R2 | % hn tpt  tn 
  R2 |R2 |R2 | % tym perc fol 
  R2 |R2 | % hpL hpR 
  ...
  <c ees fis a>2--) |  <aes aes'>2  |  R2 |  R2 |   % rh lh kbR kbL   
  R2 |R2 |R2 |R2 | % fl ob kl bn 
  R2 |  R2 | R2 | % hn tpt  tn 
  R2 |R2 |R2 | % tym perc fol 
  R2 |R2 | % hpL hpR 
  ...
  \time 6/8 bes \times 3/2{aes8 bes }| \lyricmode {that did you } |
   ...
   <<{ a'8 gis fis  e d c }\\{ fis e d c bes aes }>> | R2. |  R2. |  R2. |   % rh lh kbR kbL   
   R2. |R2. |R2. |R2. | % fl ob kl bn 
   R2. |  R2. | R2. | % hn tpt  tn 
   R2. |R2. |R2. | % tym perc fol 
   R2. |R2. | % hpL hpR 
  ...
  g'2 | <g=, bes des g>2\arpeggio |  R2 |  R2 |   % rh lh kbR kbL   
  R2 |R2 |R2 |R2 | % fl ob kl bn 
  R2 |  R2 | R2 | % hn tpt  tn 
  R2 |R2 |R2 | % tym perc fol 
  R2 |R2 | % hpL hpR 
  ...
  g=''8 fis e d  | R2 |  R2 |  R2 |   % rh lh kbR kbL   
  R2 |R2 |R2 |R2 | % fl ob kl bn 
  R2 |  R2 | R2 | % hn tpt  tn 
  R2 |R2 |R2 | % tym perc fol 
  R2 |R2 | % hpL hpR 
  ...
  cis8 d b d | R2 |  R2 |  R2 |   % rh lh kbR kbL   
  R2 |R2 |R2 |R2 | % fl ob kl bn 
  R2 |  R2 | R2 | % hn tpt  tn 
  R2 |R2 |R2 | % tym perc fol 
  R2 |R2 | % hpL hpR 
...
R2 | r4. ees=8 |  R2 |  R2 |   % rh lh kbR kbL   
R2 |R2 |R2 |R2 | % fl ob kl bn 
R2 |  R2 | R2 | % hn tpt  tn 
R2 |R2 |R2 | % tym perc fol 
R2 |R2 | % hpL hpR 
...
%bn73
  ...
  \times 2/3 {ees,='4( des8 } | ees4 |  r4. r4 |  r4. r4 |   % rh lh kbR kbL   
  r4. r4 |r4. r4 |r4. r4 |r4. r4 | % fl ob kl bn 
  r4. r4 |  r4. r4 | r4. r4 | % hn tpt  tn 
  r4. r4 |r4. r4 |r4. r4 | % tym perc fol 
  r4. r4 |r4. r4 | % hpL hpR 
  ...
  c4.) | aes,4. |  r4. r4 |  r4. r4 |   % rh lh kbR kbL   
  r4. r4 |r4. r4 |r4. r4 |r4. r4 | % fl ob kl bn 
  r4. r4 |  r4. r4 | r4. r4 | % hn tpt  tn 
  r4. r4 |r4. r4 |r4. r4 | % tym perc fol 
  r4. r4 |r4. r4 | % hpL hpR 
  ...
  fis'='8( e b gis | e=,2 |  R2 |  R2 |   % rh lh kbR kbL   
  R2 |R2 |R2 |R2 | % fl ob kl bn 
  R2 |  R2 | R2 | % hn tpt  tn 
  R2 |R2 |R2 | % tym perc fol 
  R2 |R2 | % hpL hpR 
...
R4.                                                 | <d e gis b>\p                             |  R4. |  R4. |   % rh lh kbR kbL   
R4. |R4. |R4. |R4. | % fl ob kl bn 
R4. |  R4. | R4. | % hn tpt  tn 
R4. |R4. |R4. | % tym perc fol 
R4. |R4. | % hpL hpR 
...
R1 | des2~( des8 d-.) r4 |  R1 |  R1 |   % rh lh kbR kbL 
R1 | R1 | R1 | R1 | % fl ob kl bn 
R1 |  R1 |  R1 | % hn tpt  tn 
R1 | R1 | R1 | % tym perc fol 
R1 | R1 | % hpL hpR 
...
R2 | bes,8-. <bes' d> <a d> <ges d'> |  R2 |  R2 |   % rh lh kbR kbL 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 |  R2 |  R2 | % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<f g b d>2\arpeggio | g,8-.\> <b' d>\! r4 |  R2 |  R2 |   % rh lh kbR kbL 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 |  R2 |  R2 | % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
\time 2/4 d4 r8 \instrumentSwitch "Dan" gis, | \lyricmode {mind... My } |
 ...
 <f aes b ees>2 r4 |f2. |  R2. |  R2. |   % rh lh kbR kbL 
 R2. | R2. | R2. | R2. | % fl ob kl bn 
 R2. |  R2. |  R2. | % hn tpt  tn 
 R2. | R2. | R2. | % tym perc fol 
 R2. | R2. | % hpL hpR 
 ...
 r4 fis8-. fis,-. | R2 |  R2 |  R2 |   % rh lh kbR kbL 
 R2 | R2 | R2 | R2 | % fl ob kl bn 
 R2 |  R2 |  R2 | % hn tpt  tn 
 R2 | R2 | R2 | % tym perc fol 
 R2 | R2 | % hpL hpR 
...
r4 \times 2/3 {fis8( f e) } | a2 |  R2 |  R2 |   % rh lh kbR kbL 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 |  R2 |  R2 | % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
R2. | r4 gis4 cis  |  R2. |  R2. |   % rh lh kbR kbL 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. |  R2. |  R2. | % hn tpt  tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
r4 r4. | r4 r g=8~ |  r4. r4 |  r4. r4 |   % rh lh kbR kbL 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 |  r4. r4 |  r4. r4 | % hn tpt  tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
\dQQ \time 8/8 \set Timing.beatStructure = #'(3 2 3) 
 ...
 <<{ges4( f)}\\{ees4~( \times 2/3 {ees4 des8)}}>> r2 | <<{c='4~( \times 2/3 {c4 des8)}} \\ {a2( aes2} \\ {s2 aes,8 bes bes des}  >>|  R1 |  R1 |   % rh lh kbR kbL 
 R1 | R1 | R1 | R1 | % fl ob kl bn 
 R1 |  R1 |  R1 | % hn tpt  tn 
 R1 | R1 | R1 | % tym perc fol 
 R1 | R1 | % hpL hpR 
...
R2 R4. | aes4 d, bes'4 r8  |  r2 r4. |  r2 r4. |   % rh lh kbR kbL 
r2 r4. | r2 r4. | r2 r4. | r2 r4. | % fl ob kl bn 
r2 r4. |  r2 r4. |  r2 r4. | % hn tpt  tn 
r2 r4. | r2 r4. | r2 r4. | % tym perc fol 
r2 r4. | r2 r4. | % hpL hpR 
...
<< {a'8( g) \times 2/3 {g4( fis8} d8) } \\ {<c e>4( d4.) } >>| r4 r4. |  r4. r4 |  r4. r4 |   % rh lh kbR kbL 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 |  r4. r4 |  r4. r4 | % hn tpt  tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
%bn1
\mark \default \time 3/2 r2\fermata \times 2/3 {e='2 gis4} \times 2/3 {dis2 e4\fermata } | \lyricmode {I re -- mem -- ber } |
...
r4. fis='~( | << {bes8 c d8~ d4.~}\\{<f, aes>2.}>> |  R2. |  R2. |   % rh lh kbR kbL   
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | R2. | % hn tpt  tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
fis8 g16~ g16) r8 |<< d='4. \\ b4. >> |  r8. r |  r8. r |   % rh lh kbR kbL   
r8. r | r8. r | r8. r | r8. r | % fl ob kl bn 
r8. r | r8. r | r8. r | % hn tpt  tn 
r8. r |  r8. r | r8. r | % tym perc fol 
r8. r | r8. r | % hpL hpR 
...
e8 b' gis b | b2 |  R2 |  R2 |   % rh lh kbR kbL   
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | R2 | % hn tpt  tn 
R2 |  R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
fis8(  cis' a4) | R2 |  R2 |  R2 |   % rh lh kbR kbL   
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | R2 | % hn tpt  tn 
R2 |  R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<cis e bes'>2 | <c ees ges bes>2 |  R2 |  R2 |   % rh lh kbR kbL   
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | R2 | % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
cis b a g cis e-> r  |  cis b a g cis e->  r |  r2 r4. |  r2 r4. |   % rh lh kbR kbL   
r2 r4. | r2 r4. | r2 r4. | r2 r4. | % fl ob kl bn 
r2 r4. | r2 r4. | r2 r4. | % hn tpt  tn 
r2 r4. |  r2 r4. | r2 r4. | % tym perc fol 
r2 r4. | r2 r4. | % hpL hpR 
...
<g ees>8 r <bes des e> r | ees8 r g r |R2 |R2 |   % rh lh kbR kbL 
R2 |R2 |R2 |R2 | % fl ob kl bn 
R2 |R2 | R2 | % hn tpt  tn 
R2 |R2 |R2 | % tym perc fol 
R2 |R2 | % hpL hpR 
...
<bes des e>2. | <fis fis'>2 r4 |R2. |R2. |   % rh lh kbR kbL 
R2. |R2. |R2. |R2. | % fl ob kl bn 
R2. |R2. | R2. | % hn tpt  tn 
R2. |R2. |R2. | % tym perc fol 
R2. |R2. | % hpL hpR 
...
<f gis cis>4. | cis4.~ |R4. |R4. |   % rh lh kbR kbL 
R4. |R4. |R4. |R4. | % fl ob kl bn 
R4. |R4. | R4. | % hn tpt  tn 
R4. |R4. |R4. | % tym perc fol 
R4. |R4. | % hpL hpR 
...
<a cis e>8\< <a b e > <a c e> <a c ees>4--\! <a b dis fis>8\< |<a a'>8 <gis gis'>  <g g '>   <fis fis'>4  <f f'>8 |R2. |R2. |   % rh lh kbR kbL 
R2. |R2. |R2. |R2. | % fl ob kl bn 
R2. |R2. | R2. | % hn tpt  tn 
R2. |R2. |R2. | % tym perc fol 
R2. |R2. | % hpL hpR 
...
r4 \times 2/3 {r4 \times 2/3 {f16~ aes~ b~}} | <d d'>8-> r4. |R2 |R2 |   % rh lh kbR kbL 
R2 |R2 |R2 |R2 | % fl ob kl bn 
R2 |R2 | R2 | % hn tpt  tn 
R2 |R2 |R2 | % tym perc fol 
R2 |R2 | % hpL hpR 
