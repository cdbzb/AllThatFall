...
<f=' a>2~ <f a>8 <e g> <c e> <g c>) | <c c'>1 | % rh lh 
...
r4 <a c~ f>2 <g c f>4 | <f f'>2( <c c'> | % rh lh 
R1  | R1  | R1  | R1  | % fl ob kl bn 
R1  | R1  | % hn tn 
R1  | R1  | R1  | % tym perc fol 
R1  | R1  | % hpL hpR 
...
<dis fis a c>4~ <dis fis a c>4. | r4 r4. | % rh lh 
...
<e fis gis>2\arpeggio | <fis= gis c>2\arpeggio | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
d4.)\stop c8 |  \lyricmode {you } |
 ...
 %bn21
  ...
  r4. <fis gis c>4.\arpeggio r8 | r4. r4. r8 | % rh lh 
 ...
 %bn23
  \dQQ r4 d'8 d | \lyricmode {take my } |
   r4 <f bes d>8 <f bes d> |f8\sustainOn( bes d4) | % rh lh 
   R2 | R2 | R2 | R2 | % fl ob kl bn 
   R2 | R2 | % hn tn 
   R2 | R2 | R2 | % tym perc fol 
   R2 | R2 | % hpL hpR 
 ...
 %bn24
  ...
  <<{d'4 c8 a f}\\{<f a>4 s4.}>> | <f, a d>4.~ <f a d>4 | % rh lh 
  r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
  r4. r4 | r4. r4 | % hn tn 
  r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
  r4. r4 | r4. r4 | % hpL hpR 
 ...
 %bn39
   ...
   r4 <g b ees>4-. <g b f'>-. |r8 g r2 | % rh lh 
   R2. | R2. | R2. | R2. | % fl ob kl bn 
   R2. | R2. | % hn tn 
   R2. | R2. | R2. | % tym perc fol 
   R2. | R2. | % hpL hpR 
...
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
R2 | R2 | R2 | R2 | R2 | % vn vII va vc cb % % % these three chords ????   


 %bn60
\time 2/4 cis'='8\stop gis b cis | \lyricmode {race -- course with it's } |
R2| \clef treble r8 b'='( cis gis| % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
e8 <e fis> <e gis>4 <e fis ais>8| e'=4~( e8. dis16) dis8 | % rh lh 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 | r4. r4 | % hn tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
<e fis ais dis>4. <a c f>8~ | dis4. <d, d'>8~ | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
e4 <c d fis gis>2 r4 | a2 gis4 r | % rh lh 
R1  | R1  | R1  | R1  | % fl ob kl bn 
R1  | R1  | % hn tn 
R1  | R1  | R1  | % tym perc fol 
R1  | R1  | % hpL hpR 
...
<< {<a=' a'>4\arpeggio <g g'>8 <f f'>}\\<c' e>2 >> | <g g'>2 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<< { <e, e'>4 <d d'>8 <e e'> <f f'>~ } \\ {<a c>2 <bes des>8~} >> |  <fis fis'>4.~ <fis fis'>4 | % rh lh 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 | r4. r4 | % hn tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
<< { <f f'>4\arpeggio <e e'>8 <d d'> } \\ <a' c>2 >> | <c c'>2 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
R2 | R2 | R2 | R2 | R2 | % vn vII va vc cb %rhythm ????????

 %bn80
c8^"sepre rit" b8 c( d~ | \lyricmode {un -- der -- stand } | 
<< {<c, c'>8  <b b'>8  <c c'>  <d d'>~} \\ {fis8 g8 a fis} \\ {d4 e4} >> | <b b'>2 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<< { <d d'>4 <c c'>8 } \\ <fis ais>4. >> | <f f'>4.~ | % rh lh 
R4. | R4. | R4. | R4. | % fl ob kl bn 
R4. | R4. | % hn tn 
R4. | R4. | R4. | % tym perc fol 
R4. | R4. | % hpL hpR 
...
<b b'>8 <fis fis'> <d d'> <a' a'> |  <f f'>2 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
\clef bass e,,8 b' g e'8~| <e g b e>2~ <e g b e>~ | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
\time 2/4 b8 cis16 dis \times 2/3 {cis8( dis) b} fis'8 dis16 b r8 \instrumentSwitch "Tyler" a'=16\noBeam b | \lyricmode {where did I put that hand -- ker -- cheif? when you } |
 ...
 %bn88
   \time 3/4 \times 2/3 {cis4 a8 } f'4-. g-. | \lyricmode {say the last train } |
    \clef treble \times 2/3 {cis'='4 a8 } <a cis f>4-. <b dis g>-. | \times 2/3  {cis'=4 a8 } <a cis f>4-. <b dis g>-. | % rh lh 
    R2. | R2. | R2. | R2. | % fl ob kl bn 
    R2. | R2. | % hn tn 
    R2. | R2. | R2. | % tym perc fol 
    R2. | R2. | % hpL hpR 
...
<d e fis a>8-. r4. | <d d'>8-.  r4 b8  | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
r4 <cis fis ais cis>8 | r4 <fis fis'>8 | % rh lh 
R4. | R4. | R4. | R4. | % fl ob kl bn 
R4. | R4. | % hn tn 
R4. | R4. | R4. | % tym perc fol 
R4. | R4. | % hpL hpR 
...
<g' ais cis e>4.~ <g ais cis e>4 r8 <g ais cis e>8 |< g g'>4.~ <g g'>4 r8 <fis fis'>8 | % rh lh 
r2 r4. | r2 r4. | r2 r4. | r2 r4. | % fl ob kl bn 
r2 r4. | r2 r4. | % hn tn 
r2 r4. | r2 r4. | r2 r4. | % tym perc fol 
r2 r4. | r2 r4. | % hpL hpR 
...
\time 4/4 <ais cis e g>2 \times 2/3 {<gis' b>4 <f gis> <d f>} | <f f'>8( <e e'> <f f'> <fis fis'> <g g'> <gis gis'> <a a'> <ais ais'>) | % rh lh 
R1 | R1 | R1 | R1 | % fl ob kl bn 
R1 | R1 | % hn tn 
R1 | R1 | R1 | % tym perc fol 
R1 | R1 | % hpL hpR 
...
R2 | <fis fis'>16( <gis gis'> <ais ais'> <b b cis'> <cis cis'> <dis dis'> <eis eis'> <fis fis'>) | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<ais cis fis>4. <gis cis eis>4 <fis ais cis fis>8 | \times 3/2 {r8 <cis cis'>8~} <cis cis'>8 <cis cis'>4 | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
R2. | <fis fis'>8 <fis fis'>  <g g'>  <gis gis'>  <a a'>  <ais ais'> | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
r8 <b dis> <b dis> <b dis>\> << {<b dis> <b dis>\!}\\ c4\p>>| b8-. r8 r2 | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
r8 <b d> <b d> <b d>\> << {<b d> <b d>}\\ fis4\p>>| g8-. r8 r2 | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
r4. r4 | << <bes ees>4.\\ees >> ees8 r | % rh lh 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 | r4. r4 | % hn tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
r8. r8. | \times 3/2 {f16 g} \times 3/2 {a16 bes}  | % rh lh 
r8. r | r8. r | r8. r | r8. r | % fl ob kl bn 
r8. r | r8. r | % hn tn 
r8. r | r8. r | r8. r | % tym perc fol 
r8. r | r8. r | % hpL hpR 
...
r8. <f bes d>8.-. | \times 3/2 {c16 a} r8. | % rh lh 
r8. r | r8. r | r8. r | r8. r | % fl ob kl bn 
r8. r | r8. r | % hn tn 
r8. r | r8. r | r8. r | % tym perc fol 
r8. r | r8. r | % hpL hpR 
...
\clef treble aes=4. <a g>4 <a g>8 | aes4. g4 g8 | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
<< {c8 b a gis}\\<e gis>2 >> r4.| << {c,8 b a gis}\\<e gis>2 >> \times 3/2 {a8 g}| % rh lh 
r2 r4. | r2 r4. | r2 r4. | r2 r4. | % fl ob kl bn 
r2 r4. | r2 r4. | % hn tn 
r2 r4. | r2 r4. | r2 r4. | % tym perc fol 
r2 r4. | r2 r4. | % hpL hpR 
...
f4~ \times 2/3 {f8 r4} | <f g b>4:32~ \times 2/3 {<f g b>8 r4 } | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
R2. | <fis fis'>16( <gis gis'> <ais ais'> <b b cis'> <cis cis'> <dis dis'> <eis eis'> <fis fis'>) <cis cis>8. <cis cis'>16 | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
fis8. f e16 dis | r8. r r8 | % rh lh 
 r8. r r8  |  r8. r r8  |  r8. r r8  |  r8. r r8  | % fl ob kl bn 
 r8. r r8  |  r8. r r8  | % hn tn 
...
r4 r16 d cis b a g\> fis e\! | R2. | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
<< {<bes'= ees g bes>4.\arpeggio <ees aes c ees>\arpeggio}\\d8_"not">>| d4. aes, | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
<gis b e>4.\arpeggio <g b d f>2\arpeggio <gis cis f>4.\arpeggio | e4. g2 cis,4. | % rh lh 
r4. r2 r4. | r4. r2 r4.  | r4. r2 r4.  | r4. r2 r4.  | % fl ob kl bn 
r4. r2 r4.  | r4. r2 r4.  | % hn tn 
...
<fis gis bis dis>4 r2 | gis2.  | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
R1 |r4 \times 3/4 {g=4( fis f e)} | % rh lh 
R1 | R1 | R1 | R1 | % fl ob kl bn 
R1 | R1 | % hn tn 
R1 | R1 | R1 | % tym perc fol 
R1 | R1 | % hpL hpR 
...
R2. | << {ees4.~ ees4 g8}\\{des4. bes}>> | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
R2. | <g'= b>8 <gis bis>16 <a cis> <bes d>8~ <bes d>4. | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
<fis a c dis>8-> r4. | <fis fis'>8 r4. | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<d f aes c>4.\arpeggio | <d d'>4.\arpeggio | % rh lh 
R4. | R4. | R4. | R4. | % fl ob kl bn 
R4. | R4. | % hn tn 
R4. | R4. | R4. | % tym perc fol 
R4. | R4. | % hpL hpR 
...
r4. r4 | <des g bes>4.~ <des g bes>4 | % rh lh 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 | r4. r4 | % hn tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
<< {<ees g>8 <d f>16 <c ees>16~ <c ees>4}\\<ees g>2>> | <f a>2| % rh lh 
R2  | R2  | R2  | R2  | % fl ob kl bn 
R2  | R2  | % hn tn 
R2  | R2  | R2  | % tym perc fol 
R2  | R2  | % hpL hpR 
...
r4. r4 | <gis gis'>4~ <gis gis'>8 <fis fis'>4 | % rh lh 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 | r4. r4 | % hn tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
<b dis fis>4 r4. | <b fis>4 r4. | % rh lh 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 | r4. r4 | % hn tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
<c e a>2\arpeggio | <c e a>2\arpeggio | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<< {ais'4( a8)}\\<c, dis fis>4.>> |<< {ais''4( b8)}\\<c, dis fis>4. >> | % rh lh 
R4. | R4. | R4. | R4. | % fl ob kl bn 
R4. | R4. | % hn tn 
R4. | R4. | R4. | % tym perc fol 
R4. | R4. | % hpL hpR 
...
r4 a'8( gis) | r4 <a a'>8( <gis gis'>)  | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
gis4 fis8. eis16  | <gis gis'>4 <fis fis'>8 <eis eis'> | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<b a'b>8 a gis8. eis16 | <a a'>8 <a a'> <gis gis'> <eis eis'> | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<fis a cis fis>2 | <fis fis'>2 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<< {<gis' b>8 a gis a b}\\{e,4.~ e4} >> | << {c'4.~c4)}\\ {<e, gis >4.~ <e gis >4} >> | % rh lh 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 | r4. r4 | % hn tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
r2. <b dis fis>8 | <c c'>4. <b b'>4. <a a'>8 | % rh lh 
r2 r4. | r2 r4. | r2 r4. | r2 r4. | % fl ob kl bn 
r2 r4. | r2 r4. | % hn tn 
r2 r4. | r2 r4. | r2 r4. | % tym perc fol 
r2 r4. | r2 r4. | % hpL hpR 
...
<a a'>4. c8( b a~ a4) | <b dis fis b>4. r4. r4 | % rh lh 
R1 | R1 | R1 | R1 | % fl ob kl bn 
R1 | R1 | % hn tn 
R1 | R1 | R1 | % tym perc fol 
R1 | R1 | % hpL hpR 
...
ais'='8( e fis gis ais bis  | <<{fis8 gis ais2)}\\d,2.)>> | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
<b dis fis b>4. <g bes>\arpeggio | <a a'>4. <g bes d g>\arpeggio | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
r4. r r |<< {d'4.( ees e) } \\{ <g,~ bes>2. <g c>4.} >>| % rh lh 
...
\time 6/8 \times 3/2 {c'8 b } \times 3/2 {bes a}  | \lyricmode { bur -- ning to a } |
 \times 3/2 {c8 b } \times 3/2 {bes a}  |\times 3/2 {<c a>8 <b gis> } \times 3/2 {<g bes> <fis a>}  | % rh lh 
 R2. | R2. | R2. | R2. | % fl ob kl bn 
 R2. | R2. | % hn tn 
 R2. | R2. | R2. | % tym perc fol 
 R2. | R2. | % hpL hpR 
...
R2. | r4  \times 2/3 {r2 <fis,=, fis'>4 } | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
r4 <g~ bes~ ees~>4:32\< | r4 <ees=,~ ees'~>4:32 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<g~ bes~ ees~>2:32 | <ees~ ees'~>2:32 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<aes c e>2\f |<< {<ees aes>2} \\ {aes,8( bes c4)} >> | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
R2 |  << {<f' aes>8( <ees g> <des f> <c ees aes>)} \\ {f,2} >> | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
R2 | << {d=2:32\glissando\fermata(} \\ {<bes aes>:32\glissando(} >> | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
R2 |  << {ees2:32~\fermata} \\ {<g,~ a~>2:32)} >> | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
R2 | R2 | R2 | R2 | R2 | % vn vII va vc cb 
 ...
 %bn228
R2 | | 
<c=~ d~ fis~>2:32\< | << {ees'2:32} \\ {<g,~ a~>2:32\>} >> | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
R2 | R2 | R2 | R2 | R2 | % vn vII va vc cb 
 ...
 %bn229
R2 | | 
<c~ d~ fis~>2:32 | << {e'2:32} \\ {<g,~ a~>2:32} >> | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
R2 | R2 | R2 | R2 | R2 | % vn vII va vc cb 
 ...
 %bn230
R2 | | 
<c d fis>2:32\! | << {fis'2:32)} \\ {<g, a>2:32\!} >> | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<< {<d'~ d'~>2} \\ {<g b>8( <fis a> <e g> <d fis>} >>| <d, d'>2:32 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<< {<d' d'>2} \\ {<c e>8 <b d> <a c> <g b>)} >>| <d, d'>2:32 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
R2 | R2 | R2 | R2 | R2 | % vn vII va vc cb 
 ...
 %bn233
\time 11/16 r2 r8. | |
f,=16 f' e, e' c, c' b, b' d, d' a,_"etc." | r2 r8. | % rh lh 
...
<aes'=' c ees g>2\arpeggio | R2 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
r8 <a cis e g>4.\arpeggio | R2 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<aes c ees ges>4. r4. r4. | <aes ees' aes>4. r4. r4. | % rh lh 
r4. r r | r4. r r | r4. r r | r4. r r | % fl ob kl bn 
r4. r r | r4. r r | % hn tn 
r4. r r | r4. r r | r4. r r | % tym perc fol 
r4. r r | r4. r r | % hpL hpR 
...
<g b d f>4. r4. r4. | <g b d f>4. r4. r4. | % rh lh 
r4. r r | r4. r r | r4. r r | r4. r r | % fl ob kl bn 
r4. r r | r4. r r | % hn tn 
r4. r r | r4. r r | r4. r r | % tym perc fol 
r4. r r | r4. r r | % hpL hpR 
...
r4. << {c4( b8)} \\ {<d, f aes>4.} >> r4. | r4. r4. r4. | % rh lh 
r4. r r | r4. r r | r4. r r | r4. r r | % fl ob kl bn 
r4. r r | r4. r r | % hn tn 
r4. r r | r4. r r | r4. r r | % tym perc fol 
r4. r r | r4. r r | % hpL hpR 
...
r2 <a cis e g>4\arpeggio  |  r2 a4 | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
R1  | \repeat unfold 4 {<g bes e>8 } c,2 | % rh lh 
R1 | R1 | R1 | R1 | % fl ob kl bn 
R1 | R1 | % hn tn 
R1 | R1 | R1 | % tym perc fol 
R1 | R1 | % hpL hpR 
...
<e gis b>4 <e gis c> r8 | <b~ b'~>4:32 <b~ b'~>4.:32 | % rh lh 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 | r4. r4 | % hn tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
R4  b8\glissando\< |<b b'>4.:32 | % rh lh 
R4. | R4. | R4. | R4. | % fl ob kl bn 
R4. | R4. | % hn tn 
R4. | R4. | R4. | % tym perc fol 
R4. | R4. | % hpL hpR 
