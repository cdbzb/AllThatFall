...
%bn1
\time 2/4 R2 | |
r4. f8-.(^"childs voice" | R2 |  R2 |  R2 |   % rh lh kbR kbL   
...
r4 \clef treble e='8 fis gis a gis a b cis b a   | << {r4  e\laissezVibrer}\\f2>> gis4\laissezVibrer b\laissezVibrer dis\laissezVibrer b\laissezVibrer |  R2. |  R2. |   % rh lh kbR kbL   
R2. |R2. |R2. |R2. | % fl ob kl bn 
R2. |  R2. | R2. | % hn tpt  tn 
R2. |R2. |R2. | % tym perc fol 
R2. |R2. | % hpL hpR 
