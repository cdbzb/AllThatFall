...
melody = { 
	...
	\time 5/8 \rit		d4\startTextSpan  \times 3/4 {a8 b c b~} |
	\time 3/4			 b c b b4 a8\stopTextSpan \tempo 4 = 45| %3
...
\parallelMusic #'(rhand lhand) {
  \partial 2 r2                   | \clef bass r2             | 
  \time 4/4< e g c >2\arpeggio r2 | < c c' >2 r4 < c c' >8 r8 | 
  < fis a d >4\arpeggio           | < d d' >4                 | 
}
