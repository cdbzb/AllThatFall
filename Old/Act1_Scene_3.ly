...
\instrumentSwitch "Tyler"
\tempo 4 = 60 \time 2/4 a4~ \times 2/3 {a='8 a a}      | \lyricmode{Come, Miss -- es  }                        | 
...
\instrumentSwitch "Tyler" \time 2/4 a4~ \times 2/3 {a8 a a}      | \lyricmode{Come, Miss -- es  }                        | 
< c, f a>4~ \times 2/3 {<c f a>8 <c f a> <c f a>}    | \clef bass <f f'>2                                    | 
a8( g4) \rt \rit f16(\start e)                       | \lyricmode{Roo -- ney  }                              | 
<c e a>4 r4                                          | <e e'>4 <d d'>                                        | 
e4\stop r8. e16                                      | \lyricmode{come. The }                                | 
