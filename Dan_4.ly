...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<< \new Staff \with {alignAboveContext = #"rh"} {fis8-. d'~ d r4. r4 r4. fis=''8-.( d'4) b8-.( g'8~ g) r4. R2 R4. a=''8-.( f'4 d) b8-.( g'4 e c) a=''8-.( fis'4 d) b8-.(  R2 r8 g e' b gis'4 }   %%% ossia
{e4  cis8) r4. r2 g8-.( e'4 cis) a8-.( fis'4) r  R2 R4. R2. a=''8-.( fis'4 d) b8-.(  g'4 e c) R2 r4 a8 fis' cis ais' }>> |R4 | 
...
\time 2/4  c4 r\fermata | \lyricmode {man! } |
  ...
  \clef bass <e= g>2. | cis4.( b8 <a, gis'>4)  |
  e8 b dis b r fis' | \lyricmode {ars -- ey vers -- ey our } |
R2. | g''8( b c dis) e4 | 
\time 6/8  fis2.~ | \lyricmode {tears } |
r4. \times 3/2{ fis8( gis } | r4. \times 3/2 { <dis,, dis'>8( <e e'>} |
...
\clef treble r8 g=' ees g <des' ees>4 |a8-.) r8 r2 |  
  ...
  e4 fis8 dis4 fis8 | \lyricmode {doc -- tors gave me } |
   <b dis fis>4. <b dis fis> | R2. |    
  \time 9/8 gis4. \tempo "rush" fis4. d4. | \lyricmode {up! You knew } |
  <e gis>4. \times 3/2 {<fis a>8 <e gis>} \times 3/2 {<d fis>8 <c e>} | r4. r4. r4. | 
...
r4 <fis b d>4( <f a c ees>\arpeggio)       | <fis b d>2( <f a c ees>4\arpeggio)                | 
\time 2/4 ees8 d bes g                     | \lyricmode { tor -- pid in the }                  | %% Check MM
<< {ees=''8( d bes g)} \\ <g bes ees>2 >>  | << {ees='8( d bes g)} \\ <g bes ees>2 >>          | 
\time 5/4 \tQQ ges4 des ees4  r4 f4        | \lyricmode {dust we are }                         | 
\clef bass ges,4( des ees <a, b>2)         | ges,4( des ees2) << s4\\ f'4 >>                   | 
\time 3/4 \tEE  f4 e8 fis gis8 a4 gis b2 | \lyricmode {a -- lone there is no -- one to ask } | 
r4 \clef treble e='8 fis gis a gis a b cis b a   | << {r4  e\laissezVibrer}\\f2>> gis4\laissezVibrer b\laissezVibrer dis\laissezVibrer b\laissezVibrer | 
