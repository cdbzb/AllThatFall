...
%bn9  
  ...
  \tag #'vocal {r4. <f g b>8} | R2 |  R2 |  R2 |     % lh rh kbR kbL 
...
%bn10  
  ...
  \tag #'vocal {<ees g c>2} | R2 |  R2 |  R2 |    % lh rh kbR kbL 
  R2 |R2 | R2  |   R2 | % fl ob kl bn   
...
%bn20  
  ...
  <e g bes cis'>8->\! r <g ais cis' e'>4 r |\absolute { <e' g' bes' cis''>8->\! r <g' ais' cis'' e''>4 r }   |  R2. |  R2. |  %lh rh kbR kbL
