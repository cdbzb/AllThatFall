...
R2. |  R2. |  R2. |  R2. |  R2. |  R2. |  % I  II  III  IV  V  kill cello and bn tags on somewhere
...
R2. |  R2. |  R2. |  R2. |  R2. |  R2. |  % I  II  III  IV  V  VI  
%parts: fl | vII | hn | va | cb | tn or tpt
...
R2 |  R2 |  R2 |  R2 |  R2 |  R2 |  % I  II  III  IV  V  VI  
%parts: fl | vn | hn | va | cb | tn or tpt
...
%parts: tn or tpt | vII | rest | va | cb | vc
