...
R2 | R2 | a4. r8 | f4. r8 | R2 |  % vn vII va vc cb 
 \instrumentSwitch "vabass" \Q #"va" {s2 }|  \Q #"vn" { s2 } |  \Q #"hn" { s2 }|  \Q #"vnII" { s2 }|  \Q #"cb" { s2 }| \Q "vc" { s2 } |  % I  II  III  IV  V  VI     rh lh 
...
R2. |  \Q #"vn" { s2. } | \instrumentSwitch "vn" \Q #"vn" {s2. }| \instrumentSwitch "vatreble" \Q #"va" {s2. }|  \Q #"cb" { s2. }| \Q "vc" { s2. } |  % I  II  III  IV  V  VI     
...
r4. r4  |  \Q #"vn" { s4. s4 } |  \Q #"vn" { s4. s4 }|  \Q #"va" { s4. s4 }| \instrumentSwitch "bn" \Q #"bn" {s4. s4 }| \Q "vc" { s4. s4 } |  % I  II  III  IV  V  VI     
...
<<d''8. \\ d'8.>> r16 g''8\p a''16 b'' | r4 g'8:32 a'16 b'| R2 | <d a>4 r | d,4 r |  % vn vII va vc cb 
 \instrumentSwitch "kl" \Q #"kl" {s2 }|  \Q #"ob" { s2 }| \instrumentSwitch "hn" \Q #"hn" {s2 }| \Q #"vn" {s2 }|  \Q #"cb" { s2 }| \Q "vc" { s2 } |   % I  II  III  IV  V  VI     
% Error: too many parts 7
...
R2. |  \Q #"ob" { s2. }| \instrumentSwitch "vn" \Q #"vII" {s2. }|  \Q #"vn" { s2. }|  \Q #"cb" { s2. }| \Q "vc" { s2. } |   % I  II  III  IV  V  VI     
...
r4. r4 |  \Q #"ob" { s4. s4 }|  \Q #"vII" { s4. s4 }|  \Q #"vn" { s4. s4 }|  \Q #"cb" { s4. s4 }| \Q "vc" { s4. s4 } |  % I  II  III  IV  V  VI     
...
R2. |  \Q #"ob" { s2. }|  \Q #"vII" { s2. }|  \Q #"vn" { s2. }|  \Q #"cb" { s2. }| \Q "vc" { s2. } |   % I  II  III  IV  V  VI     
...
%bn323
 ...
 r8 <b'' cis''' dis''' e'''\o>8.~ q8~ q | r8 r8. r8 r | r8 r8. r8 r | fis8~( fis8.~ fis8 e8) | r8 r8. r8 r |  % vn vII va vc cb 
   \Q #"kl" \clef treble { s8. s s }| \instrumentSwitch "vn" \Q #"vn" {s8. s s }|  \Q #"hn" { s8. s s }|  \Q #"va" { s8. s s }|  \Q #"cb" { s8. s s }| \Q "vc" { s8. s s } |  % I  II  III  IV  V  VI     
...
\instrumentSwitch "klsilent" << {r2 e''\trill}\\{ r8 e'2\trill r4. } >>|  \Q #"vn" { s1 }|  \Q #"hn" { s1 }|  \Q #"va" { s1 }|  \Q #"cb" { s1 }| \Q "vc" { s1 } |  % I  II  III  IV  V  VI     
...
<< {r2 e''\trill}\\{  e'2.\trill r4 } >> r4 |  \Q #"vn" { s2. s2 }|  \Q #"hn" { s2. s2 }|  \Q #"va" { s2. s2 }|  \Q #"cb" { s2. s2 }| \Q "vc" { s2. s2 } |  % I  II  III  IV  V  VI     
...
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
 b8(^"mutes" c'16 b a b c' d' e' f' g' a' | b8(^"mutes" c'16 b a g f e f d e g | <<{d'2.}\\{b,}>>| g,2. | g,,2. | % vn vII va vc cb 
...
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
 a2~ \times 2/3 {a'8) a' a'}|a'2~) | << {f'2} \\ {c'2~} >>  |f4 f' | f,2 | % vn vII va vc cb 
...
%bn417
 ...
 \instrumentSwitch "va" \Q #"va" {s4. s4 }|  r4. r4 |\Q #"hn" {s4. s4 }|  r4. r4 | \instrumentSwitch "cb" \Q #"cb" {s4. s4 }| \instrumentSwitch "vc" \Q #"vc" {s4. s4 }|  % I II III IV V VI        
%parts: va | rest | hn | rest | cb | vc
 ...
 R2. | R2. | r4. <fis' fis''>8 <e' e''><dis' dis''>| R2. | % fl ob kl bn 
 e,4. r |r4. dis''8 b' fis'|  R2. | % hn tpt  tn 
 R2. | R2. | R2. | % tym perc fol 
 R2. | R2. | % hpL hpR 
  R2. |r4.  dis''8 b' fis' |e'4. b'8-.^"solo" fis'-. ais-. | e4. r | e,,4. r |  % vn vII va vc cb 
 \instrumentSwitch "kl" \Q #"kl" {s2. }| \instrumentSwitch "tpt" \Q #"tpt" {s2. }|\Q #"hn" {s4. } \instrumentSwitch "vn" \Q"vII" {s4.} | \Q #"va" {s2. }|\Q #"cb" {s2. }|\Q #"vc" {s2. }|  % I II III IV V VI        
...
%Error: too many parts 7
 ...
 r8. r r | r8. r r | <c' c''>8. <b b'>4. | g8.~ g g | % fl ob kl bn 
 r8. r r |c''8. b'4. |  r8. r r | % hn tpt  tn 
 r8. r r | r8. r r | r8. r r | % tym perc fol 
 r8. r r | r8. r r | % hpL hpR 
 <g''~ c'''>8. <g'' b''>4.                                                                 |\times 18/12 {c''32 e''g'' c'''e''' g''' b''' g''' d''' b'' g'' d''} | <c'' c'''>8.:32 <b' b''>4.:32 | e'4. d'8. | r8. r r |  % vn vII va vc cb 
 ...
 r8. r | r8. r | <bes bes'>8. <a a'> | f4. | % fl ob kl bn 
 r8. r | bes'8. a' |  r8. r | % hn tpt  tn 
 r8. r | r8. r | r8. r | % tym perc fol 
 r8. r | r8. r | % hpL hpR 
 <f''~ bes''>8. <f'' a''>  |\times 12/17 { a''32 bes'' c''' d''' g''' a''' bes''' c'''' d'''' c'''' bes''' a''' g''' d''' c''' bes'' a'' }| <bes' bes''>8.:32 <a' a''>8.:32 | d'4. | r8. r |  % vn vII va vc cb 
  r8. r |  r8. r |  r8. r |  r8. r |  r8. r |  r8. r |  % I II III IV V VI        

 %bn421
 \dEQ \time 3/8 fis8 g a                                                 | \lyricmode{be -- ing mo -- }                           | 
 R4.                                                                     | <fis fis'>4.                                                    |  R4. |  R4. |   %rh lh kbR kbL 
 R4. | R4. | R4. | fis,8 g a | % fl ob kl bn 
 fis,8 g a |  R4. |  R4. | % hn tpt  tn 
 R4. | R4. | R4. | % tym perc fol 
 R4. | R4. | % hpL hpR 
...
R2. | R2. |  R2. |  R2. |   %rh lh kbR kbL 
R2. | R2. |e''8  r4 ais'8. dis' |e'8 r4 fis16 r8 b16 r8 | % fl ob kl bn 
R2. |  R2. |  R2. | % hn tpt  tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
R2. | R2. | R2. | R2. | R2. |  % vn vII va vc cb 
...
R2 | R2 | \repeat unfold 4 {ais''32 b''32} r4 | R2 | % fl ob kl bn 
R2 |  R2 | <fis b>4 r| % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
R2 | R2 | \repeat unfold 4 {a''32 b''32} r4 | R2 | % fl ob kl bn 
R2 |  R2 | <fis b>4 r| % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
r4 r4. r2 | r4 r4. r2 | r4 r4. r2 | % tym perc fol 
...
gis''8~^"sul pont" <gis'' a''>4. b''8~ <b'' c'''>2|\octaves{\absolute{gis'8 a' fis' gis' a' b' c'' a' b'}}| r4 r4. \octaves{\absolute{dis'8( d' cis' c'}} |gis8( g fis  f e dis d cis c | r4 r4. r2 |  % vn vII va vc cb 
  r4 r4. r2 |  r4 r4. r2 |  r4 r4. r2 |  r4 r4. r2 |  r4 r4. r2 |  r4 r4. r2 |  % I II III IV V VI        

%bn443
\time 2/4 \QdE \times 2/3 { cis8( d cis) } cis c16 b | \lyricmode{pelt, out of my }                      | 
R2                                                   | b4 \times 2/3 {cis8 c b}                          |  R2 |  R2 |   %rh lh kbR kbL 
R2 | R2 | b4) \times 2/3 { cis''8( c'' b'} | r4 \times 2/3 {cis8 c b} | % fl ob kl bn 
...
R4. |  R4. | bes'8 a' aes' | bes a aes |  % fl ob kl bn
f e ees |  R4. |  R4. | % hn tpt tn
R4. | R4. | R4. | % tym perc fol
R4. | R4. | % hpL hpR
...
R2 | R2 | g'8 ges' f' e' | g8 ges f e | % fl ob kl bn
...
r4. r4 | r4. r4 | dis'4 r8 dis'4 | dis4 r8 dis4 | % fl ob kl bn 
