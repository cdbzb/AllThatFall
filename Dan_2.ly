...
<dis fis>4(\< <e g> <f aes> <fis a>)\!            | <dis fis>4( <d f> <des fes> <c ees>)            | % rh lh 
...
r4. b8 c  cis16 d  r4.                                                      | r4. b'8 bes a16 aes g8-. ees-. b-.              | % rh lh 
...
<< {<e=' e'>8 <f f'> <f f'> <ees ees'> <c c'> <g g'> }\\{<aes=' c>4 <aes c>2}>> | r4 <ees ees'>2                                  | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
R2. | <fis=, fis'>4 <d d'> <gis gis'> | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
r4. r r | <e= fis ais>4.( <ees f b>) r | % rh lh 
r4. r r | r4. r r | r4. r r | r4. r r | % fl ob kl bn 
r4. r r | r4. r r | % hn tn 
r4. r r | r4. r r | r4. r r | % tym perc fol 
r4. r r | r4. r r | % hpL hpR 
...
r2. <f g b>4 | <g bes des f>4) e=4( f) <f g b>4 | % rh lh 
R1 | R1 | R1 | R1 | % fl ob kl bn 
R1 | R1 | % hn tn 
R1 | R1 | R1 | % tym perc fol 
R1 | R1 | % hpL hpR 
...
<ges aes c>4 r2.| <ges aes c>4 f4( e f)| % rh lh 
R1 | R1 | R1 | R1 | % fl ob kl bn 
R1 | R1 | % hn tn 
R1 | R1 | R1 | % tym perc fol 
R1 | R1 | % hpL hpR 
...
<d a cis>4 r8 <d a cis>8 <fis, a d>4 | a4 r8 a d4 | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
\instrumentSwitch "Rooney"
 ...
 r4 gis4\fermata                         | ees8 e4.\fermata                       | % rh lh 
 R2 | R2 | R2 | R2 | % fl ob kl bn 
 R2 | R2 | % hn tn 
 R2 | R2 | R2 | % tym perc fol 
 R2 | R2 | % hpL hpR 
 ...
 r4 b4\fermata r8 <<a8 \\ a,8 >>         | fis8 g4.\fermata r4                    | % rh lh 
 R2. | R2. | R2. | R2. | % fl ob kl bn 
 R2. | R2. | % hn tn 
 R2. | R2. | R2. | % tym perc fol 
 R2. | R2. | % hpL hpR 
 ...
 <<{bes'4. a8 g4 f8 }\\{bes,4.  a8~ a4 bes8}>>  |<<{r8 d4. ees4 r8 }\\{r8 ges, f4~ f4.~ }>>| % rh lh 
...
\times 2/3 {g4 a8} \times 2/3 {b8( a) g} \times 2/3 {<g a  cis>( d' cis)} | R2. | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
R4.                                                  | ges'8-. des-. ges,-.                 | % %enharmonic?? % rh lh 
R4. | R4. | R4. | R4. | % fl ob kl bn 
R4. | R4. | % hn tn 
R4. | R4. | R4. | % tym perc fol 
R4. | R4. | % hpL hpR 
...
r4. r4. r4.                                          | e,8 r e bes'4. e,4.                  | % rh lh 
r4. r r | r4. r r | r4. r r | r4. r r | % fl ob kl bn 
r4. r r | r4. r r | % hn tn 
r4. r r | r4. r r | r4. r r | % tym perc fol 
r4. r r | r4. r r | % hpL hpR 
...
<d f aes b>8 <g c> <g c> <g c>       | R2                                    | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<a c f>4 <a c f>8 <a c f>            | R2                                    | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<g c e g >4  <g c e g >8  <g c e g > | R2                                    | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
r2 \times 2/3{a='8 g f}| r2 g=,4~ | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
\grace g16( f16) e d c b a                                                 | g4.~                                                   | % rh lh 
R4. | R4. | R4. | R4. | % fl ob kl bn 
R4. | R4. | % hn tn 
R4. | R4. | R4. | % tym perc fol 
R4. | R4. | % hpL hpR 
...
<e g b e>2\arpeggio <d f a d>4\arpeggio                        | e=8 d \times 2/3 {c b a} g4~           | % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
<< {b8 c b c }\\{<d, f g>4 <d f g>}>> | R2 | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<g bes c e>4.\arpeggio r4. r4 | << {<bes c e>4.~\arpeggio( <bes c e>4.~ <bes c e>4\< }\\ {g4.~ g4.~ g4 } >> | % rh lh 
R1 | R1 | R1 | R1 | % fl ob kl bn 
R1 | R1 | % hn tn 
R1 | R1 | R1 | % tym perc fol 
R1 | R1 | % hpL hpR 
...
<< {cis4. d8} \\ <gis, f'>2 >>  |<< {cis4.( d8} \\ <gis, f'>2 >>  | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<< {c4 d8 e}\\{c4. bes8} >>|<< e'2) \\<g, e'>2>>| % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
<< {<a c f>2.}\\{r4 <f' b>^"bray" <f b> }>>| <c f>2. | %or f in the bass % rh lh 
R2. | R2. | R2. | R2. | % fl ob kl bn 
R2. | R2. | % hn tn 
R2. | R2. | R2. | % tym perc fol 
R2. | R2. | % hpL hpR 
...
<< {f='8 e f4.~}\\{f8 e d4.}>> | r4. <bes=,, bes'>4 | % rh lh 
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn 
r4. r4 | r4. r4 | % hn tn 
r4. r4 | r4. r4 | r4. r4 | % tym perc fol 
r4. r4 | r4. r4 | % hpL hpR 
...
a4) r | \times 2/3 {b8 r b8 } \times 2/3 {e8 r4 }  | % rh lh 
R2 | R2 | R2 | R2 | % fl ob kl bn 
R2 | R2 | % hn tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
%  \new Staff \relative c {\clef bass \lh fl ob kl bn hn tn tym perc fol hpL hpR vn vII va vc cb}
%>>
% % \midi{}
%}
