...
R1 | R1 | R1 | % tym perc fol
R1 | R1 | % hpL hpR->
bes'4 a'16 g' f' e' d'8 e' r8 cis' |bes'4 a'16 g' f' e' d'8 e' r8 ais |bes4 a16 g f e d8 e~ e4 |bes2. bes4 | R1 |  % vn vII va vc cb 
...
R1 | R1 | R1 | % tym perc fol
R1 | R1 | % hpL hpR
ais4. r8 e'4.\f e'8 |fis'4 ais r2  | R1 | R1 | R1 |  % vn vII va vc cb 
...
R1 | R1 | R1 | % tym perc fol
R1 | R1 | % hpL hpR
R1 | R1 | R1 |  % vn vII va vc cb 
R1 |  R1 |  R1 |  R1 |  R1 |  R1 |       R1 | R1 | % I II III IV V VI
...
\transpose c g, \relative c' { r4. r8 <<a'8 \\ dis,>>  }|\ottava #0 \transpose c g, \relative c, {  bes2 <<c''8 \\ b8 >>  }|  r4. r4 |  r4. r4 |  % rh lh kbR kbL
r4. r4 | r4. r4 | r4. r4 | r4. r4 | % fl ob kl bn
r4. r4 |  r4. r4 |  r4. r4 | % hn tpt  tn
r4. r4 | r4. r4 | r4. r4 | % tym perc fol
r4. r4 | r4. r4 | % hpL hpR
...
\transpose c g, \relative c' { <<{a'4( gis2.)}\\{dis4.( e4~ e4.)}>>  }|\transpose c g, \relative c, { << {c''2( b8 gis b e)}\\ {b4 r4}>>  }|  R1 |  R1 |  % rh lh kbR kbL
R1 | R1 | R1 | R1 | % fl ob kl bn
R1 |  R1 |  R1 | % hn tpt  tn
R1 | R1 | R1 | % tym perc fol
R1 | R1 | % hpL hpR
...
<< <f bes d>2\arpeggio \\ {bes8( f' d'4)}>> |  bes2~ |  R2 |  R2 |  % rh lh kbR kbL
R2 | R2 | R2 | R2 | % fl ob kl bn
R2 |  R2 |  R2 | % hn tpt  tn
R2 | R2 | R2 | % tym perc fol
R2 | R2 | % hpL hpR
