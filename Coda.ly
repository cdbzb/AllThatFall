...
<a cis e>8\< <a b e > <a c e> <a c ees>4--\! <a b dis fis>8\< |<a a'>8 <gis gis'>  <g g '>   <fis fis'>4  <f f'>8 |
c8 ees ges b4 g8 | \lyricmode {car -- ry a -- bout with } |
<a c dis fis> <a c dis fis> <a c dis fis> <b e g b>4.->\! | <e e'>8 <dis dis'>  <d d'>  <cis cis'>4.~ | 
\time 3/4 \dQQ cis,4 r8 \instrumentSwitch "Rooney" d e8 fis| \lyricmode {me I have no } |
r4. <<{d8 e fis}\\d4.~>>  | <cis cis'>2 r4| 
\time 6/8 \QdQ a4. g8 fis g | \lyricmode { small mo -- ney have } |
 <<{a'4. g8 fis g}\\{d4.~ d4 e8}>> | R2.  | 
...
R2. | R2. |   
\time 2/4 R2 | |
 <<{r8. c16 b a g f}\\ {r16 c' b a g f r8} >>  | R2 | 
R2 |  |
<< {e16 d e f g a b c }\\{ r8. d,16 e f g a }>> | R2 |
\time 7/8 \set Timing.beatStructure = #'(3 4) r4. r2 | |
<< {e'4( d8)}\\{<fis, a c>4.}>> <<{b4( a8)}\\<cis, e g>4.>> r8 | <<{r8 g4}\\fis4.>> << {r8 d'4}\\cis4.>> r8 |
\time 2/4 r4. r8\fermata | |
<< {e'4( d8)}\\<fis, a c>4.>> r8 | <<{r8 g4}\\fis4.>> r8 |
R2 \bar "|." | |
R2 | c2 | 
