...
\Q "kl" {s2 }|\Q "fl" {s2 }|\Q "vn" {s2 }|\clef treble \Q "va" {s2 }|\Q "bn" {s2 }|\Q "vc" {s2 }|  % I  II  III  IV  V  VI    
...
%bn47  
 ...
 <f a cis>4 g\! | R2 |  R2 |  R2 |    % lh rh kbR kbL 
  ...
  R2 | cis''8 b'16 a' g'8 a'16 b'\! | %vn vn2  
  << {a'4 g'\!} \\ {f' g'}>>   | f4 f, | R2 |  % va vc cb 
\Q "kl" {s2 }|\clef bass \Q "fl" {s2 }|\Q "vII" {s2 }|\Q "va" {s2 }|\Q "bn" {s2 }|\Q "vc" {s2 }|  % I  II  III  IV  V  VI    
...
%bn89  
  ...
  \instrumentSwitch "kl" \Q "kl" {s8. s }| \instrumentSwitch "tn" \Q "tn" {s8. s }| \instrumentSwitch "hn" \Q "hn" {s8. s }| \instrumentSwitch "vatreble" \Q "va" {s8. s } |\instrumentSwitch "cb" \Q "cb" {s8. s }|\instrumentSwitch "vc" \Q "vc" {s8. s }|  % I  II  III  IV  V  VI    
...
\instrumentSwitch "va"  <e g>4.~ | \clef treble \Q "tn" {s4. } | \Q "hn" {s4. }|\instrumentSwitch "vasilent" \grace e'16( g'16 fis' e' dis' e' fis' |\Q "cb" {s4. }|\Q "vc" {s4. }|  % I  II  III  IV  V  VI    
...
%bn94  
 ...
 \instrumentSwitch "va"   <c e f a >4~ <c e g b >~  |  \instrumentSwitch "fl" \Q "fl" {s2 } |\Q "hn" {s2 }|  <c' e' f' a'>4~ <c' e' g' b'>~  | \instrumentSwitch "ob" \Q "ob" {s2} | << {< f a>4 <g b>~}\\<c e>2~ >> |  % I  II  III  IV  V  VI    
...
%bn132  
  ...
  R2 | R2 | %vn vn2  
  R2 | R2 | R2 |  % va vc cb 
  \instrumentSwitch "kl" \Q "kl" {s2 }| \instrumentSwitch "fl" \Q "fl" {s2 }|\instrumentSwitch "ob" \Q "ob" {s2 }| \clef bass \Q "tn" {s2 } |\instrumentSwitch "bn" \Q "bn" {s2 }|\Q "vc" {s2 }|  % I  II  III  IV  V  VI    
...
%bn140  %%%%%%%%%%%%%%examine these shakes in the harp ! more notes?
  ...
  \instrumentSwitch "vatreble" \Q "va" {s2 }| \instrumentSwitch "vn" \Q #"vII" {s2 }|\Q "ob" {s2 }|\Q "vn" {s2 } |\instrumentSwitch "cb" \Q "cb" {s2 }|\Q "vc" {s2 }|  % I  II  III  IV  V  VI    
...
r2. r2  | << {bes4 d f aes \times 2/3 {c8 e d~ }}  \\ {<bes,, bes'>1~ <bes bes'>4} >> |  r2. r2 |  r2. r2 |   % lh rh kbR kbL 
  ...
  bes,4^"harm." d f a \times 2/3 {c'8( e' d')}| r2. r2 | %vn vn2  
...
%bn160  
  ...
  r4. r r  |  << gis'4. \\ eis'4. >> r r  | \Q "hn" {\clef treble s4. s s } |\instrumentSwitch "fl" \Q "fl" {s4. s s } | \Q "bn" {s4. s s }| \Q "vc" {s4. s s  }|  % I  II  III  IV  V  VI    
...
%bn161  
 ...
 <cis eis gis>4 <cis eis gis>   |<cis, cis'>4 <cis cis'>   |  R2 |  R2 |   % lh rh kbR kbL 
  ...
  R2 | R2 | %vn vn2  
  R2 | R2 | R2 |  % va vc cb 
  R2 | \clef bass \Q "tn" {s2 } | \Q "hn" {\clef treble s2 } |\instrumentSwitch "ob" \Q "ob" {s2 } | \Q "bn" {s2 }| \Q "vc" {s2  }|  % I  II  III  IV  V  VI    
...
%bn162  
  ...
  R2 | \Q "tn" {s2 } | \Q "hn" {\clef treble s2 } | <cis' fis'>4.  \instrumentSwitch "vabass" <a, c>8 | \Q "bn" {s2}  | \Q "vc" {s2  }|  % I  II  III  IV  V  VI    
...
%bn163  %%%%%%%%%%%% RHYTHM WONKEY!!!!
 ...
 <fis a c fis>2  |  <dis dis'>2     |  R2 |  R2 |   % lh rh kbR kbL 
  ...
  R2 | \Q "tn" {s2 } | \Q "hn" {\clef treble s2 } | \Q "va" {s2 } |  \instrumentSwitch "vn" \Q "vn" {s2 } | \Q "vc" {s2  }|  % I  II  III  IV  V  VI    
...
R2.  |r4. dis8~ dis4  |  R2. |  R2. |   % lh rh kbR kbL 
  ...
  R2. | \Q "tn" {s2. } | \instrumentSwitch "hnsilent" dis'8.) r16 <<{\times 2/3 {r2 \clef treble a'8 r}}\\{\times 2/3 {r4 \clef bass fis,-. r}}>> | \Q "va" {s2. } | \Q "vn" {s2. }| \Q "vc" {s2.  }|  % I  II  III  IV  V  VI    
...
%bn165  
  ...
  R2.  | \Q "tn" {s2. } | \Q "hn" {\clef treble s2. } | \Q "va" {s2. } | \Q "vn" {s2. }| \Q "vc" {s2.  }|  % I  II  III  IV  V  VI    
...
%bn166  
  ...
  \Q "vn" {s2 } | \Q "tn" {s2 } | \Q "hn" {\clef treble s2 } | \clef treble \Q "va" {s2 } | \Q "ob" {s2 }| \Q "vc" {s2  }|  % I  II  III  IV  V  VI    
...
%bn171  
  ...
  \Q "vn" {s2. } | \Q "tn" {s2. } | \Q "hn" {\clef treble s2. } | \clef bass \Q "va" {s2. } | \Q "ob" {s2. }| \Q "vc" {s2.  }|  % I  II  III  IV  V  VI    
...
%bn173  
  ...
  R4 | R4 | %vn vn2  
  e'4 | e'4 | R4 |  % va vc cb 
  \Q "vn" {s4 } | \Q "tn" {s4 } | \Q "hn" { s4 } | \Q "va" {s4 } | \Q "ob" {s4 }| \Q "vc" {s4  }|  % I  II  III  IV  V  VI    
...
<a'' f'''>4 <g'' e'''> r| R2. | R2. | R2. |  % fl ob kl bn    
  ...
  R2.  |\Q "fl" {s2. } | \Q "hn" {\clef treble s2. } | \Q "va" {s2. } | \Q "vn" {s2. }| \Q "vc" {s2.  }|  % I  II  III  IV  V  VI    
...
%bn213
 ...
 r4. r4 |  r4. r4 | % hpL hpR 
  ...
  r4. r4  | \Q "tn" { s4. s4 } |  \Q "vn" { s4. s4 } | \clef treble \Q "va" { s4. s4 } | \Q "cb" { s4. s4 } | \instrumentSwitch "vcsilent"<< {r4.  fis4--}\\{ <b, dis>4. r4}  >>  |  % I  II  III  IV  V  VI     
 ...
 \instrumentSwitch "kl" \Q "kl" { s4. s4 } | \Q "tn" { s4. s4 } |  \Q "fl" { s4. s4 } |\relative c'' {< e gis b e>4)  g8 a fis } | \Q "cb" { s4. s4 } |\Q "vc" { s4. s4 } |  % I  II  III  IV  V  VI     IV plays both vn and va
...
\instrumentSwitch "blanktn" <<{r8 e'16 dis'}\\{b,,4}>> |  \Q #"vn" { s4 }| \instrumentSwitch "vn" \Q #"vII" {s4 }|  \Q #"tn" { s4 }|  \Q #"cb" { s4 }| \Q "vc" { s4 } |  % I  II  III  IV  V  VI     
...
R2. | \instrumentSwitch "vn" \Q #"vII" {s2. }|  \Q #"hn" { s2. }| \instrumentSwitch "vatreble" \Q #"va" {s2. }| \Q "cb" {s2.} | \Q "vc" { s2. } |  % I  II  III  IV  V  VI     
...
%bn273
\time 3/4 \dQQ
cis8 a b cis dis4 |\lyricmode{noon of my con -- cep -- tion }|%
R2. |R2.|  R2. |  R2. |   % rh lh kbR kbL 
...
R1 | dis'4 c'  a4) r | R1 | R1 | R1 |  % vn vII va vc cb 
  \Q #"kl" { s4 \clef bass s2.  }|  \Q #"vII" { s1 }|  \Q #"hn" { s1 }|  \Q #"vII" { s1 }| \instrumentSwitch "bn" \Q #"bn" {s1 }| \Q "vc" { s1 } |  % I  II  III  IV  V  VI     
...
R1. | R1. | r2. r2 dis4~ | <<b2.\\{s4\< s s\!}>> r2.  | <<f,,2.\\{s4\< s s\!}>> r2.  |  % vn vII va vc cb 
  \clef treble \Q #"kl" { s1. }| \instrumentSwitch "tn" \Q #"tn" {s1. }|  \Q #"hn" { s1. }|  \Q #"vII" { s1. }|  \Q #"cb" { s1. }| \Q "vc" { s1. } |  % I  II  III  IV  V  VI     
...
r2. r2. r2 | r2. r2. r2 | g2 ais4~ ais2 b2. |a,2 r4 gis,2 r4 b,4 r |a,,2 r4 gis,,2 r4 b,,4 r |  % vn vII va vc cb 
  \Q #"kl" { s2. s2. s2 }|  \Q #"ob" { s2. s2. s2 }|  \Q #"hn" { s2. s2. s2}|  \Q #"tn" { s2. s2. s2}|  \Q #"cb" { s2. s2. s2}| \Q "vc" { s2. s2. s2} |  % I  II  III  IV  V  VI     
% Error: too many parts 7
...
e'2 cis' ais | cis'2 bes \times 2/3 {g4( fis f)} | e1. | cis2 bes, \times 2/3 {g,4( fis, f,)} | cis,,1. |  % vn vII va vc cb 
  \instrumentSwitch "kl" \Q #"kl" { s1. }| \instrumentSwitch "ob"  \Q #"ob" { s1. }| \instrumentSwitch "vn" \Q #"vn" {s1. }|\instrumentSwitch "tntreble"  \Q #"tpt" { s1. }|\instrumentSwitch "cb" \Q #"cb" { s1. }|\instrumentSwitch "vc" \Q "vc" { s1. } |  % I  II  III  IV  V  VI     
...
g2 r1 |e2 r1 | R1. |e,2 r4 <<{g,2^"Soli" r4}\\{fis,4 r2}>>  |r2. <g, d>2.\arpeggio |  % vn vII va vc cb 
  \Q #"kl" {s1. }| \instrumentSwitch "vn" \Q #"vn" {s1. }| \instrumentSwitch "hn" \Q #"hn" {s1. }| \clef treble \instrumentSwitch "vn" \Q #"vII" {s1. }| \Q #"cb" { s1. }| \clef bass \Q "vc" { s1. } |  % I  II  III  IV  V  VI     
...
R2 | R2 | \relative c' {r4 fis8 eis16 dis } |fis,4-> fis~ | R2 |  % vn vII va vc cb 
 \instrumentSwitch "kl" \Q #"kl" {s2 }| \instrumentSwitch "tntreble" \Q #"tpt" {s2 }|  \Q #"hn" { s2 }| \instrumentSwitch "vabass" \Q #"va" {s2 }|  \Q #"bn" { s2 }| \Q "vc" { s2 } |  % I  II  III  IV  V  VI     
...
r8. r8 r | r8. r8 r | r8. r8 r | e8.~ e16) dis e fis | r8. r8 r |  % vn vII va vc cb 
  \Q #"kl" { s8. s8 s }| \Q #"fl" {  s8. s8 s  }|  \Q #"hn" { s8. s8 s }|  \Q #"va" { s8. s8 s }|  \Q #"cb" { s8. s8 s }| \Q "vc" { s8. s8 s } |   % I  II  III  IV  V  VI     
...
{ \repeat tremolo 16 {e''32( g''32) }}| R1 | R1 | <c e~ g~>2:32 <e g>2:32 | e,2.:32 r4 |  % vn vII va vc cb 
   \Q #"kl" { s1 }|  \Q #"fl" { s1 }|  \Q #"hn" { s1 }|  \Q #"vn" { s1 }|  \Q #"cb" { s1 }| \Q "vc" { s1 } |  % I  II  III  IV  V  VI     
...
r8. r  | \instrumentSwitch "vnbass" \Q #"vII" {s8. s }|  \Q #"hn" { s8. s }|  \Q #"va" { s8. s }|  \Q #"cb" { s8. s }| \Q "vc" { s8. s } |  % I  II  III  IV  V  VI     
...
R2. | r4 b-. b,-.| r8. <fis, fis>16 r4 r8. q16 | r4 b,8-. fis,-. b,,-.^"*" \clef treble g'32(\< gis' g' gis' | R2. |  % vn vII va vc cb RANGE-vln
  \Q #"vII" { s2. }|  \Q #"vn" { s2. }|  \Q #"hn" { s2. }|  \Q #"va" { s2. }|  \Q #"cb" { s2. }| r4 b,8-. fis,-. b,,-.^"*" \clef treble g'32(\< gis' g' gis' |  % I  II  III  IV  V  VI     
...
<ees''' ges'''>2^"solo"\pp( | aes''2:32 | <ees' aes'>2:32 | aes2:32\p | aes,2:32\p |  % vn vII va vc cb 
 \instrumentSwitch "tn" \Q #"tn" {s2 }| \instrumentSwitch "vn" \Q #"vn" {s2 }|\instrumentSwitch "vn" \Q #"vII" {s2 }| \instrumentSwitch "va" \Q #"va" {s2 }|  \Q #"bn" { s2 }|\Q #"vc" { s2 }|  % I II III IV V VI       
% Error: too many parts 7
...
d''4. d''8 d''16 | r8. r r | << {<g' b'>8( <fis' a'> <e' g'> <d' fis>16) r q }\\{<a d'>4. q16 r q}>> |<<{ <g' b'>8( <fis' a'> <e' g'>)  } \\ d'4.~ >> <d' fis'>16 r q   |<<{ <g' b'>8 <fis' a'> <e' g'> } \\ d'4.~ >> <d' fis'>16 r q   |  % vn vII va vc cb 
  \Q #"fl" { s8. s s }|  \Q #"ob" { s8. s s }|  \Q #"hn" { s8. s s }|  \Q #"vn" { s8. s s }|\instrumentSwitch "cbsilent" \clef treble <<{ <g' b'>8 <fis' a'> <e' g'> } \\ d'4.~ >> <d' fis'>16 r q   |\instrumentSwitch "vcsilent" <<{ <g' b'>8( <fis' a'> <e' g'>)  } \\ d'4.~ >> <d' fis'>16 r q   |  % I II III IV V VI       
% Error: too many parts 8
...
<< e''4. \\{ r8  e'32 g' c'' g'' c''' e''' c''' g''}>> d''8. c''16 b'8 | r4. e'32^"trem ad lib" g' c'' g'' c''' e''' c''' g''  e'' c'' g' e'  | < c' g' c''>2. | << c''2. \\ {c8^"double pz" d e f g a}>> | \clef bass <c,, c,>2. |  % vn vII va vc cb 
 \instrumentSwitch "tn" \Q "tn" {s2. } | c'4 r8 \instrumentSwitch "vn" {e'32(^"trem ad lib" g' c'' g'' c''' e''' c''' g''  e'' c'' g' e') } | \instrumentSwitch "vn" { r8  e'32(^"trem ad lib" g' c'' g'' c''' e''' c''' g'')}  d''8. c''16-. b'8 | \instrumentSwitch "va" \Q #"va" {s2.  }|  \clef "bass_8" \Q #"cb" { s2. }|c8 d e f g a|  % I II III IV V VI        
...
\Q #"tn" {s2. }| \instrumentSwitch "vn" \Q #"vn" {s2. }|  \Q #"hn" { s2. }|  \Q #"tn" { s2. }| \instrumentSwitch "bn" \Q #"bn" {s2. }| \clef bass \Q #"vc" { s2. }|  % I II III IV V VI   %\tEE
...
\Q #"tn" {s8 s8.  }|  \Q #"vn" { s8 s8. }|  \Q #"hn" { s8 s8. }| \instrumentSwitch "vatreble" \Q #"va" {s8 s8. }| \instrumentSwitch "bn" \Q #"bn" { s8 s8. }| \Q #"vc" { s8 s8. }|  % I II III IV V VI        
...
R2 | R2 | % hpL hpR 
 ...
 \instrumentSwitch "kl" \Q #"kl" {s2 }| \instrumentSwitch "vn" \Q #"vn" {s2 }|  \Q #"hn" { s2 }| \instrumentSwitch "vatreble" \Q #"va" {s2 }|  \Q #"bn" { s2 }| \Q #"vc" { s2 }|  % I II III IV V VI        
...
%bn374
\dQQ \time 5/8 e4. a,8-. cis-.                         | \lyricmode{home straight back }             | 
...
e'4 r8. e'16 | e'2) | << c'2 \\ g~ >> | << {c4 e} \\ c2 >> | c,2\p | % vn vII va vc cb 
  \Q #"vII" { s2 }| \instrumentSwitch "fl" \Q #"fl" {s2 }|  R2  |  \Q #"va" { s2 }| \instrumentSwitch "cb" \Q #"cb" {s2  }|c2 | % I II III IV V VI 
...
\instrumentSwitch "vatreble" \Q "va"{s4} | R4 | R4 | R4 | R4 | \Q "vc" {s4} | % I II III IV V VI 
...
R2 | R2 |r8 <d' g'>-. <d' f'>-. q-. |d8 b,  d a16( g) | % fl ob kl bn 
R2 |  R2 |  R2 | % hn tpt  tn 
R2 | R2 | R2 | % tym perc fol 
R2 | R2 | % hpL hpR 
...
g4. fis4 | \cross g'4.\lv r4 | r4. r4 | % tym perc fol 
 r4. r4 | r4. r4 | % hpL hpR 
  ...
  \Q #"tn" {s4. s4   }| \instrumentSwitch "fl" \Q "fl" {s4. s4}  |\Q #"hn" {s4. s4 }| \instrumentSwitch "va" \Q #"va" {s4. s4 }| \instrumentSwitch "cb" \Q #"cb" {s4. s4 }| \instrumentSwitch "vc" \Q #"vc" {s4. s4 } |  % I II III IV V VI        
 ...
 \instrumentSwitch "vn" \Q #"vII" {s8. s  }| \Q "fl" { s8. s }  |  \Q #"bn" { s8. s }|  \Q #"vn" { s8. s }|  r8. r  |\Q #"vc" { s8. s }| % I II III IV V VI 
...
d4 g | R2 | R2 | % tym perc fol 
 ...
 <d'' d'''>4 <a' a''> | \Q "fl" { s2 }  | \Q "bn" {s4} \instrumentSwitch "hn" \Q "hn" {s4} | \instrumentSwitch "va" \Q #"va" {s2 }|  \Q #"cb" { s2 }| \Q #"vc" { s2 }| % I II III IV V VI 
...
R2. | R2. | % hpL hpR 
 ...
 \instrumentSwitch "va" \clef treble e'''8\lv\sustainOn dis'''16\lv cis'''\lv b''2\lv | R2. | \instrumentSwitch "vn" \Q #"vn" {s2. }|\Q #"va" {s2. }|  R2. | \instrumentSwitch "vc" \clef treble \Q #"vc" {s2. }|  % I II III IV V VI       
...
R2. | R2. | % hpL hpR 
 ...
 f'8\>\lv e'16\lv d'16\lv c'2\lv| \instrumentSwitch "fl" \Q #"fl" {s2. }|  \Q #"vn" { s2. }|\Q #"va" { s2. }| \instrumentSwitch "vn" \Q #"vII" {s2. }|  \Q #"vc" { s2. }|  % I II III IV V VI       
...
R2. | g8 a16 bes a8 g16 f r4 | d'8 r8 r2 | R2. | R2. |  % vn vII va vc cb 
 \clef bass fis8\lv e16\lv dis\lv cis2\!\sustainOff |  \Q #"fl" { s2. }| R2. |\Q #"va" { s2. }|\Q #"vII" {s2. }|  R2. |  % I II III IV V VI       
...
\Q #"va" { s2. }|  R2. | \instrumentSwitch "hn" \Q #"hn" {s2. }|  R2. | \instrumentSwitch "cb" \Q #"cb" {s2. }|\Q #"vc" { s2. }|  % I II III IV V VI        
...
\Q #"va" { s2. }|\Q #"vn" { s2. }|\Q #"hn" { s2. }| \instrumentSwitch "vn" \Q #"vII" {s2. }|\Q #"cb" { s2. }|\Q #"vc" { s2. }|  % I II III IV V VI 
...
R2 | R2 | % hpL hpR 
  R2 | R2 | R2 | R2 | R2 |  % vn vII va vc cb 
R2 |  R2 |  R2 | \instrumentSwitch "tn" \Q #"tn" {s2 }|  R2 |\Q #"vc" { s2 }|  % I II III IV V VI        
...
<< \repeat unfold 4 { b''32 dis''' } s4^"solo" >> r4  | R2 | R2 | <fis b>4 r| R2 |  % vn vII va vc cb 
 \instrumentSwitch "kl" \Q #"kl" {s2 }| \instrumentSwitch "fl" \Q #"fl" {s2 }|  R2 |\Q #"tn" { s2 }|  R2 |\Q #"vc" { s2 }|  % I II III IV V VI        
...
R2 | R2 | % hpL hpR 
 \repeat unfold 4 {b''32 e'''} r4 | R2 | R2 | <fis b>4 r| R2 |  % vn vII va vc cb 
  \Q #"kl" { s2 }|  \Q #"fl" { s2 }|  R2 |\Q #"tn" { s2 }|  R2 |\Q #"vc" { s2 }|  % I II III IV V VI        
...
a''8.\f  g''16 f'' \times 2/3{e''8 d''  c'' } \times 2/3{b' 4 a'8} | <fis' c'>16  <f' b>  <fis'  c'> <gis' d'> <ais' e'> <c'' fis' > <cis'' g'> <dis'' a'> <f'' b'> \times 2/3 { <fis'' c''>8 <gis'' d''> <ais'' e''> } | <c' f' c'' f''>8.~ q8 r2| f,16 e,  f, g, a, b, c d e \times 2/3 { f8  g a}   | f,16 e,  f, g, a, b, c d e \times 2/3 { f8  g a}   |  % vn vII va vc cb 
 \instrumentSwitch "va" \Q #"va" {s8. s8 s2 }| \instrumentSwitch "vn" \Q #"vn" {s8. s8 s2 }|\Q #"vII" {s8. s8 s2 }|\Q #"tn" {s8. s8 s2 }|\Q #"cb" {s8. s8 s2 }|\Q #"vc" {s8. s8 s2 }|  % I II III IV V VI        
...
r4 r4. r2                                            | aes'8 g fis f e dis dis d cis c                       |  r4 r4. r2 |  r4 r4. r2 |   %rh lh kbR kbL 
...
gis''8~^"sul pont" <gis'' a''>4. b''8~ <b'' c'''>2|\octaves{\absolute{gis'8 a' fis' gis' a' b' c'' a' b'}}| r4 r4. \octaves{\absolute{dis'8( d' cis' c'}} |gis8( g fis  f e dis d cis c | r4 r4. r2 |  % vn vII va vc cb 
 \instrumentSwitch "kl" \Q #"kl" {s4 s4. s2 }|\Q #"vn" {s4 s4. s2 }|\Q #"hn" {s4 s4. s2 }| \instrumentSwitch "va" \Q #"va" {s4 s4. s2 }| \instrumentSwitch "vn" \Q #"vII" {s4 s4. s2 }|\Q #"vc" { s4. s s }|  % I II III IV V VI        
...
R2 r8   | ees2 r8       |  r4. r4 |  r4. r4 |   %rh lh kbR kbL 
 a'''8\stopTrillSpan r4 a'''8 r4 | r4. r4 | dis'4 r8 dis'4 | dis,4 r8 dis,4 | % fl ob kl bn 
...
R2 |  R2 | % hpL hpR 
R2 |  R2 |  R2 |  R2 |  R2 |  % vn vII va vc cb 
 \instrumentSwitch "kl" \Q #"kl" {s2 }| \instrumentSwitch "fl" \Q #"fl" {s2 }|  R2 |  R2 |  R2 |  R2 |  % I  II  III  IV  V  VI  
...
%bn478
\time 5/8 \rit aes8 \start bes c d8. bes16 | \lyricmode { to keep her out of } | % slower?
...
R4. |  R4. | % hpL hpR 
 ...
 \instrumentSwitch "va" \Q #"va" {s4. }| \instrumentSwitch "vn" \Q #"vn" {s4. }| R4. | \instrumentSwitch "vn" \Q #"vII" {s4. }|  R4. |\Q #"vc" { s4. }|  % I  II  III  IV  V  VI  
...
R2 |  R2 | % hpL hpR 
 ...
 \instrumentSwitch "vn" \Q #"vn" {s2 }|  \Q #"fl" { s2 }|  \Q #"bn" { s2 }|\Q #"va" {s2 }|  R2 |  \clef bass gis,,2~ |  % I  II  III  IV  V  VI  
...
R2   |\Q #"vn" {s2 }| r4 \instrumentSwitch "hn" \clef treble \Q #"hn" {\clef treble s4 }|\Q #"va" {s2 }|  R2 | gis,,2~ |  % I  II  III  IV  V  VI  
...
R2 |  R2 |  R2 |  R2 | gis,,4 r |  % vn vII va vc cb 
 \instrumentSwitch "tn" \Q #"tn" {s2 }|  R2 |\Q #"hn" {s2 }|  R2 | \instrumentSwitch "bn" \Q #"bn" {s2 }| gis,,4 r |  % I  II  III  IV  V  VI  
...
\instrumentSwitch "kl" \Q #"kl" {s2 }| \instrumentSwitch "fl" \Q #"fl" {s2} |  \instrumentSwitch "bn" \Q #"bn" {s2 }| \Q #"va" { s2 }| \instrumentSwitch "vn" <gis' f''>2~(  | \clef bass \Q #"vc" { s2 }|  % I  II  III  IV  V  VI  
...
\Q #"kl" { s2. }| \instrumentSwitch "tn" \Q #"tn" {s2. }| \instrumentSwitch "vn" \Q #"vn" {s2. }|    \Q "va" { s2. } |\Q #"cb" { s2. }| << {ees'8.-.^"pizz" bes ges ees}\\{ees'16 r bes ges r bes ees r ges bes, r16 b  } >> |  % I  II  III  IV  V  VI  
...
R2 |  R2 |  R2 | % tym perc fol 
R2 |  R2 | % hpL hpR 
e''16 b' gis' b' e' gis' b dis' |  R2 |e'16 b gis b e gis b, dis | e'8-.^"pizz" b-. gis-. e-.| R2 |  % vn vII va vc cb 
\Q #"kl" {s2 }| \instrumentSwitch "vn" \Q #"vn" {s2 }| \instrumentSwitch "hn" \Q #"hn" {s2 }|  \clef bass  \Q "va" { s2 } | \instrumentSwitch "bn" \Q #"bn" {s2 }|\Q #"vc" {s2 }|  % I  II  III  IV  V  VI
...
b'4 |<< a'4\\ {s16\< s8 s16\!}>>| b8( a16 b | <dis cis'>8( cis16 b, |  R4 |  % vn vII va vc cb 
 \instrumentSwitch "va" \Q #"va" {s4 }|  \Q #"vn" { s4 }|  \Q #"hn" { s4 }| \instrumentSwitch "vn" \Q #"vII" {s4 }|  \Q #"bn" { s4 }|\Q #"vc" { s4 }|  % I  II  III  IV  V  VI  
...
\times 2/3{dis''8 b' g'} fis' e' | dis'4 r| \times 2/3 {r4 g8} fis e |<< {\times 2/3{dis'8 b g} fis e }\\{\times 2/3{dis4 g,8} fis, e,}>>|b4 r |  % vn vII va vc cb 
  \Q #"va" { s2 }|  \Q #"vn" { s2 }|  \Q #"hn" { s2 }|  \Q #"vII" { s2 }|b4 r|\instrumentSwitch "vc" \Q #"vc" { s2 }|  % I  II  III  IV  V  VI  
...
\Q #"va" { s2 }|  \Q #"vn" { s2 }|  \Q #"hn" { s2 }|  \Q #"vII" { s2 }| \Q "bn" {s4} \instrumentSwitch "bn" \Q #"bn" {s4 }|\Q #"vc" { s2 }|  % I  II  III  IV  V  VI  
...
\instrumentSwitch "fl" \Q #"fl" {s2. }|  \Q #"vn" { s2. }|  \Q #"hn" { s2. }| \instrumentSwitch "va" \Q #"va" {s2. }| \Q"bn" {s2} \instrumentSwitch "vn" \Q #"vII" {s4}|\Q #"vc" { s2. }|  % I  II  III  IV  V  VI  
...
R2 |<<  { <cis' f' cis'' f''>4.}\\<f a f' a'>4.  >>r8 |<b' dis' b'' dis''>4 <b b'>8^"norm" q16 <cis' cis''> | r4 r8 a |  R2 |  % vn vII va vc cb 
  \Q #"kl" { s2 }| \instrumentSwitch "tn" \Q #"tn" {s2 }|\Q #"vn" {s2 }| \instrumentSwitch "va" \Q #"va" {s2 }|\Q #"vII" {s2 }|\Q #"vc" {s2 }|  % I  II  III  IV  V  VI  
...
r4 r r16 |  r4 r r16 |  r4 r r16 |  r4 r r16 | \tuplet 3/2 4 { r8 f,,,8 r r f,,, r } r16|  % vn vII va vc cb 
  \Q #"kl" { s8. s s }|  \Q #"tn" { s8. s s }|  \Q #"hn" { s8. s s }|  \Q #"vn" { s8. s s }|  \Q #"cb" { s8. s s }|\Q #"vc" { s8. s s }|   % I  II  III  IV  V  VI  
...
r4 \clef treble <fis' b'>^"arc" | r4 <c' ees' b'> |  R2 |  R2 | b,,,4 r |  % vn vII va vc cb 
  \clef treble \Q #"kl" { s2 }| \instrumentSwitch "vn" \Q #"vn" {s2 }|  \Q #"hn" { s2 }|  \Q #"vII" { s2 }|  \Q #"cb" { s2 }| \instrumentSwitch "tn" \Q #"tn" {s2 }|  % I  II  III  IV  V  VI  
...
r4. r4 |  r4. r4 |  r4. r4 | % tym perc fol 
r4. r4 |  r4. r4 | % hpL hpR 
r4. r4 |  r4. r4 |  r4. r4 |  r4. r4 | c8( cis d dis e)                  |  % vn vII va vc cb 
  \Q #"kl" { s4. s4 }|  \Q #"vn" { s4. s4 }|  \Q #"hn" { s4. s4 }|  \Q #"vII" { s4. s4 }|  \Q #"cb" { s4. s4 }|  \Q #"tn" { s4. s4 }|  % I  II  III  IV  V  VI  
...
R1 |  R1 |  R1 | % tym perc fol 
R1 |  R1 | % hpL hpR 
R1 |  R1 |  R1 |  R1 | cis8( d dis e f fis g4\fermata ^"cresc" |  % vn vII va vc cb 
...
cis''2^\prall^\markup{\sharp}|  R2 |  R2 |  R2 | % fl ob kl bn 
R2 |  R2 |   R2 | % hn tpt  tn 
...
b2~\p^"mute" | <d~ g>2\p^"mute" | g2 | e2 |  R2 |  % vn vII va vc cb 
  \Q #"kl" { s2 }|  \Q #"fl" { s2 }| \instrumentSwitch "vn" \Q #"vn" {s2 }|  \Q #"va" { s2 }| \instrumentSwitch "vn" \Q #"vII" {s2 }|  \Q #"vc" { s2 }|  % I  II  III  IV  V  VI  
...
R2 | r4 a'4~ |r4  <fis dis'>4~ |  R2 |  R2 |  % vn vII va vc cb 
  \Q #"kl" { s2 }|  \Q #"fl" { s2 }| \instrumentSwitch "bn" \Q #"bn" {s2 }|  \Q #"va" { s2 }|  \Q #"vII" { s2 }|  \Q #"vc" { s2 }|  % I  II  III  IV  V  VI  
...
R2 |  R2 |  R2 | % tym perc fol 
R2 |  R2 | % hpL hpR 
R2 |  R2 |  R2 | \clef bass  r4 f,4:32\glissando | r4 f,4\glissando |  % vn vII va vc cb 
  \Q #"kl" { s2 }|  \Q #"fl" { s2 }|  \Q #"vn" { s2 }|  \Q #"va" { s2 }|  \Q #"vII" { s2 }|\Q #"vc" { s2 }|  % I  II  III  IV  V  VI  
...
%bn600
 ...
 r4. r4 |  r4. r4 |  r4. r4 | a,4.:32~ 4 | a,4.~ 4 |  % vn vII va vc cb 
  \Q #"kl" { s4. s4 }|  \Q #"fl" { s4. s4 }| \instrumentSwitch "hn" \Q #"hn" {s4. s4 }|  \Q #"va" { s4. s4 }|  \Q #"cb" { s4. s4 }|\Q #"vc" { s4. s4 }|  % I  II  III  IV  V  VI  
...
R2. |  R2. | r4. \times 3/4 {f8 g a b}|  R2. |  R2. |  % vn vII va vc cb 
  \Q #"kl" { s2. }|  \Q #"ob" { s2. }|  \Q #"vn" { s2. }|  \Q #"va" { s2. }|  \Q #"vII" { s2. }|\Q #"vc" { s2. }|  % I  II  III  IV  V  VI  
%parts: va | ob | rest | rest | rest | rest
...
f16 g a bes c' d' e' f' f' g' a' bes' c'' d'' e'' f'' | \grace {d'16( dis' e'} f'8) r r2. | \clef treble c'''16 a'' f'' c'' a'' f'' c'' a' f'' c'' a' f' c'' a' f' c' |<< {\ossia "vc" {s64 \grace{c'16 f'} a'8*7/8:32 r8 \grace{a16 c'} f'8:32  r \grace {f16 a} c'8:32 r \grace{ c16 f} a8:32 r }}{  f,8 g, a, bes,4 r8 e( f)  }>>| f,,8 g,, a,, bes,, c, d, e, f, |  % vn vII va vc cb 
R1 |  R1 |  R1 |  R1 |  R1 |  R1 |  % I  II  III  IV  V  VI  
...
R2. |  R2. |  R2. |  R2. | % fl ob kl bn 
 r8 <g, d>8 a,8. b,16 cis4 |  R2. |g,2. | % hn tpt  tn 
...
%bn713
\time 6/8 \tempo 4.=60 f'8( ees) ees r4.                | \lyricmode{wast -- ing } | 
...
r4. r r |  r4. r r | <e a>4.~^"mutes" q~ q |<<\new Staff = "vasolo" \with {alignAboveContext = "va"}{\clef alto r4.^"solo" b8 r e~ e4.} { a4.~\p a~ a }>> |  r4. r r |  % vn vII va vc cb 
 \instrumentSwitch "va"  <e a>4.~^"mutes" q~ q |  \Q #"tn" { s4. s s }|  \Q #"vII" { s4. s s }|  {r4. b8 r e~ e4.}| \Q #"cb" { s4. s s }| \Q #"vc" { s4. s s }|  % I  II  III  IV  V  VI  
...
r8. r r |  r8. r r |  r8. r r |  r8. r r |  r8. r r |  % vn vII va vc cb 
  \Q #"fl" { s8. s s }|  \Q #"tn" { s8. s s }|  \Q #"vII" { s8. s s }| \Q #"va" { s8. s s }| \Q #"cb" { s8. s s }| \Q #"vc" { s8. s s }|  % I  II  III  IV  V  VI  
...
r4 \ottava #1 <g'''\o c''''\o>4\pp \ottava #0 | r4 \ottava #1 c''''4\pp \ottava #0 |  R2 |  R2 |  R2 |  % vn vII va vc cb 
 \instrumentSwitch "vn" \Q #"vn" {s2 }  |  R2 | r4 \ottava #1 c''''4\pp \ottava #0 |  R2 |  R2 |  R2 |  % I  II  III  IV  V  VI  
...
r4. r4. r4. r4 |\times 3/2{r8 <e=, e'>8~ } <<  \times 3/2{r8 d'} \\ <e=, e'>4.>> <<{\times 3/2 {r8 cis'}} \\ {<fis=, fis'>4.}>> <gis gis'>4 |   r4. r r r4 |   r4. r r r4 |   %tie in lh kbR kbL 
 r4. r r r4 |   r4. r r r4 |   r4. r r r4 |   r4. r r r4 | % fl ob kl bn 
 r4. r r r4 |   r4. r r r4 |    r4. r r r4 | % hn tpt  tn 
 r4. r r r4 |   r4. r r r4 |   r4. r r r4 | % tym perc fol 
 r4. r r r4 |   r4. r r r4 | % hpL hpR 
 r4. r r r4 |   r4. r r r4 |   r4. r r r4 |   r4. r r r4 |   r4. r r r4 |  % vn vII va vc cb 
  r4. r r r4  |   r4. r r r4  |   r4. r r r4  |   r4. r r r4  |   r4. r r r4  |   r4. r r r4  |  % I  II  III  IV  V  VI  not showing?? % rh lh 
...
<e' g bes>4\arpeggio  r r2                 | r2 r2                                        |  R1 |  R1 |   % rh lh kbR kbL 
R1 |  R1 |  R1 |  R1 | % fl ob kl bn 
R1 |  R1 |   R1 | % hn tpt  tn 
R1 |  R1 |  R1 | % tym perc fol 
R1 |  R1 | % hpL hpR 
...
%bn758
\time 2/4 ces8 d b cis16( d)                        | \lyricmode{ti -- ring soom your -- }         | 
R2                                        | R2                                           |  R2 |  R2 |   % rh lh kbR kbL 
R2 |  R2 |  R2 |  R2 | % fl ob kl bn 
R2 |  R2 |   R2 | % hn tpt  tn 
R2 |  R2 |  R2 | % tym perc fol 
...
r2 r2                                     | r2 r2                                        |  R1 |  R1 |   % rh lh kbR kbL 
R1 |  R1 |  R1 |  R1 | % fl ob kl bn 
R1 |  R1 |   R1 | % hn tpt  tn 
R1 |  R1 |  R1 | % tym perc fol 
R1 |  R1 | % hpL hpR 
...
r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | % fl ob kl bn 
r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | % hn tpt  tn 
r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | % tym perc fol 
r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | % hpL hpR 
r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} |  % vn vII va vc cb 
r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} | r2 \times 2/3 {r4} |  % I  II  III  IV  V  VI  arbitrary % rh lh 
